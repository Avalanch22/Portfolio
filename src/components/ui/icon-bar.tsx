...
const IconBarItem = React.forwardRef<HTMLButtonElement, IconBarItemProps>(
  (
    ...
    const expanded = !disabled && hoverPreview;
    ...
    return (
      <motion.button
        ...
        aria-label={label}
        className={cn(
          "relative inline-flex h-12 shrink-0 items-center overflow-hidden rounded-xl bg-white/10 text-zinc-300 outline-none backdrop-blur-md border border-white/10",
      ...
      >
        <span className="flex size-12 shrink-0 items-center justify-center">
          <Icon aria-hidden className="size-[22px] stroke-[1.5]" />
        </span>
        ...
        >
          <span className="block whitespace-nowrap pr-4 font-semibold text-[15px] tracking-wide">
            {label}
          </span>
        </motion.div>
        ...
        <span
          aria-hidden
          className="pointer-events-none absolute top-0 whitespace-nowrap pr-4 font-semibold text-[15px] tracking-wide opacity-0"
          ref={measureRef}
